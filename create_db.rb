...
#  ipsum.text_type = Faker::Lorem.paragraph
  ...
  ipsum = Ipsum.new
  ipsum.identifier = "samuel"
  ipsum.paragraph = "The path of the righteous man is beset on all sides by the iniquities of the selfish and the tyranny of evil men"
  ipsum.save

  Ipsum.create(identifier: "hipster",  paragraph: "Mustache forage trust fund, austin cold-pressed man bun")

  Ipsum.create :identifier => 'futurama', :paragraph => "Oh dear! She's stuck in an infinite loop, and he's an idiot!"
